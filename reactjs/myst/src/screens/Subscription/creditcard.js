...
class SubscriptionCreditCard extends React.Component {
	...
	hideLoading = () => {
  	...
  	render() {
      	...
      	return (
      		<StripeProvider apiKey="pk_test_SMFi1LdDZ7WlucZ2kvgA1tzH">
		        <div className="container-subscription">
		        	<Loading show={this.state.loading} />
		          <Topbar />

		          <div className="subscription full-background">
			          <Row className="logo">
			          	<Col>
			          ...
			          <Row className="credit-card-form">
			          	<Col>
			          		<MyStoreCheckout 
...
export default withContext(SubscriptionCreditCard);
