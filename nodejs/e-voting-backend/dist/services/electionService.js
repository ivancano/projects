...
const create = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const election = yield election_1.default.create(payload);
        return election;
    }
    catch (e) {
        console.log(e);
...
const update = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const election = yield election_1.default.findByPk(id);
        if (!election) {
            throw new Error();
        }
...
const deleteById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const deletedElectionCount = yield election_1.default.destroy({
            where: { id }
        });
...
const getAll = (filters) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return election_1.default.findAll(Object.assign({ where: Object.assign({}, ((filters === null || filters === void 0 ? void 0 : filters.isDeleted) && { deletedAt: { [sequelize_1.Op.not]: null } })) }, (((filters === null || filters === void 0 ? void 0 : filters.isDeleted) || (filters === null || filters === void 0 ? void 0 : filters.includeDeleted)) && { paranoid: true })));
    }
    catch (e) {
