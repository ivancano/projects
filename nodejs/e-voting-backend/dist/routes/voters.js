...
candidatesRouter.get('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield voterController.getById(id);
...
candidatesRouter.put('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield voterController.update(id, payload);
...
candidatesRouter.delete('/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = Number(req.params.id);
        const result = yield voterController.deleteById(id);
...
candidatesRouter.post('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const payload = req.body;
        const result = yield voterController.create(payload);
        return res.status(200).send(result);
    }
    catch (e) {
        console.log(e);
...
candidatesRouter.post('/login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const payload = req.body;
        const result = yield voterController.login(payload);
